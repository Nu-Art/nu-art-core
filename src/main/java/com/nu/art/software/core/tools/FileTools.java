...
import com.nu.art.software.core.file.Charsets;
import com.nu.art.software.core.file.FileType;
...
public class FileTools {
	...
	public static File[] searchForFiles(File[] sourceFolders, Condition<File> matchCondition) {
	...
	private static void searchForFile(File folder, Condition<File> matchCondition, ArrayList<File> sourceFiles) {
